...
import .Generic: add!, addeq!, addmul!, base_ring, canonical_unit, character,
                 ...
                 isconstant, isdegree, isdomain_type, isexact, isgen,
                 ishessenberg, ismonomial, isnegative, isone, isreverse,
                 isrimhook, isrref, isterm, isunit, lcm, lead, length,
                 leglength, main_variable, main_variable_extract,
                 main_variable_insert, matrix, matrix_repr, max_degrees,
                 max_precision, minpoly, mod, modulus, monomial_iszero,
                 monomial_set!, monomial_to_newton!, mul!, mul_classical,
                 mul_karatsuba, mul_ks, mullow, mulmod, needs_parentheses,
                 newton_to_monomial!, normalise, nvars, num, O, one, order,
                 ordering, parent_type, parity, partitionseq, polcoeff,
                 pol_length, powmod, pow_multinomial, popov, powers, precision,
                 primpart, pseudodivrem, pseudorem, rand_ordering,
