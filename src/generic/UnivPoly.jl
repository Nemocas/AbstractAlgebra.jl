...
function rand(rng::AbstractRNG, S::UniversalPolyRing, args...)
   return UnivPoly(rand(rng, make(base_ring(S), args...)), S)
end

rand(S::UniversalPolyRing, args...) = rand(Random.default_rng(), S, args...)
