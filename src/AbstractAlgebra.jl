...
function __init__()
   println("")
   println("Welcome to AbstractAlgebra version 0.0.4")
   println("")
...
import .Generic: add!, addeq!, addmul!, base_ring, cached, canonical_unit, character,
                 characteristic, charpoly, charpoly_danilevsky!,
                 charpoly_danilevsky_ff!, charpoly_hessenberg!, chebyshev_t,
                 chebyshev_u, _check_dim, check_parent, codomain, coeff, cols, compose,
                 content, cycles, data, deflate, degree,
                 denominator, derivative, det, det_clow,
                 det_df, det_fflu, det_popov, dim, discriminant, divexact,
                 divides, divrem, domain, downscale,
                 elem_type, elements, evaluate, exp_gcd,
                 ...
                 hooklength, identity_matrix, image_map, inflate, inskewdiag, integral,
                 ...
                 map_with_preimage_from_func, map_with_retraction_from_func,
                 map_with_section_from_func, matrix,
                 ...
                 set_length!, set_limit!, setpermstyle,
...
export add!, addeq!, addmul!, base_ring, cached, canonical_unit, character,
                 ...
                 map_with_retraction_from_func, map_with_section_from_func,
                 ...
                 resultant_sylvester, resx, retraction_map, reverse, rows, rref, rref!,
                 section_map, setcoeff!, set_length!, 
                 ...
                 trail, truncate, typed_hcat, typed_hvcat, upscale, valuation, var,
