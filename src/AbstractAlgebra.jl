...
import .Generic: add!, addeq!, addmul!, base_ring, canonical_unit, character,
                 ...
                 divides, divrem, downscale, elem_type, elements, evaluate, exp_gcd,
                 ...
                 rows, rref, rref!, section_map, setcoeff!, set_length!, setpermstyle,
...
export add!, addeq!, addmul!, base_ring, canonical_unit, character,
                 ...
                 section_map, setcoeff!, set_length!, setpermstyle, set_prec!, set_val!,
