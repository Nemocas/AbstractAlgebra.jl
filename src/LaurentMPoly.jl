...
function ConformanceTests.pseudo_random_element(R::LaurentMPolyRing{BigInt})
  n = rand(1:10)
...
function ConformanceTests.pseudo_random_element(R::LaurentMPolyRing{<:ResElem{BigInt}})
  n = rand(1:5)
  # R: length between 1 and 9
  # R: exponents between -n and n
