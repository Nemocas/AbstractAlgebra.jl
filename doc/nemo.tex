...
Here is the Julia definition of the \code{FinFieldElem} type.
...
The \code{FinFieldElem} type is parameterised by a symbol \code{S} which holds on to
...
The \code{FinFieldElem} type belongs to the \code{Field} typeclass, and therefore
