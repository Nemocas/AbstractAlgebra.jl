...
There are currently two steps to installing Nemo: install Julia-0.3 and use the Julia
...
Once Julia-0.3 is installed, start up Julia (type \code{julia} at the command 
line/shell prompt).
