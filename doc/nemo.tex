...
\desc{Return a string giving the representation of $n$ in the given base $b$. Valid bases
are $2 \leq b \leq 62$. If an invalid base is applied and error is raised.}

\begin{lstlisting}
bin(n::ZZ)
\end{lstlisting}

\desc{Return a string giving the representation of $n$ in binary, i.e. base $2$.}

\begin{lstlisting}
oct(n::ZZ)
\end{lstlisting}

\desc{Return a string giving the representation of $n$ in octal, i.e. base $8$.}

\begin{lstlisting}
bin(n::ZZ)
\end{lstlisting}

\desc{Return a string giving the representation of $n$ in decimal, i.e. base $10$.}

\begin{lstlisting}
bin(n::ZZ)
\end{lstlisting}

\desc{Return a string giving the representation of $n$ in hexadecimal, i.e. base $16$.}
