...
Secondly, when the signature does not include the type parameter \code{S}, access should be provided
to parameters of types of objects via a supported interface, e.g. \code{parameters(typeof(a))}.
...
=={S, M}(x::Residue{ZZ, M}, y::Poly{Residue{ZZ, M}, S})
\end{lstlisting}
