...
if $m$ is not found to be a power of \code{p = prime(Padic{S})}. Note that
at present we require $n \geq 0$. This will be extended in a future version of
Nemo.}
...
\begin{lstlisting}
R = PadicNumbers(7)
S = PadicNumbers(ZZ(65537))

a = R()
b = R(1)
c = R(ZZ(123))

d = 1 + 2*7 + 4*7^2 + O(R, 7^3)
e = 13 + 357*ZZ(65537) + O(S, ZZ(65537)^12)
\end{lstlisting}
