...
This means that external libraries are must be able to implement their multivariate
formats in whatever way they see fit. The required interface here should be available,
